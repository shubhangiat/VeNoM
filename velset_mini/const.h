 ...
 #define NUM_OF_SYMBOLS 2  // Impacts vertex.* files, stands for s0-s2 symbols
 ...
 #define MIN_DEGREE 1   // Impacts vertex.cpp, computeChiSqValue, add dummy neigbour to nodes
