 ...
 #define NUM_OF_SYMBOLS 4  // Impacts vertex.* files, stands for s0-s2 symbols
 ...
 #define MIN_DEGREE 3   // Impacts vertex.cpp, computeChiSqValue, add dummy neigbour to nodes
